  ...
  return (
    <div style={{ maxWidth: "800px" }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "2rem" }}>
        <div>
          <h1 className="pf-heading-lg" style={{ marginBottom: "0.25rem" }}>🔔 Student Notifications</h1>
          <p className="pf-subtext">Course announcements, exam evaluation updates, and milestone alerts.</p>
        </div>
            ...
            {notifications.map(n => (
              <div
                ...
                style={{
                  ...
                  background: n.is_read ? "#FFFFFF" : "#ECFDF5"
                }}
              >
                <div style={{
                  width: "36px",
                ...
                <div style={{ flex: 1 }}>
                  ...
                  {n.link && (
                    <Link to={n.link} style={{ fontSize: "0.8125rem", color: "#10B981", fontWeight: "600", textDecoration: "none" }}>
                      Open Link &rarr;
                    </Link>
                  )}
                </div>
